...
try {
    ...
    $mail->setFrom('info@Paradise.com', 'Message from Ceylon Happy Laugh');             // Email Address and Name FROM
    $mail->addAddress('info@Paradise.com', 'Jhon Doe');                            // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@Paradise.com', 'Message from Ceylon Happy Laugh');       // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'Message from Ceylon Happy Laugh';                                // Email Subject       
